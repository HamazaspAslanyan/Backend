...
//        System.out.println(fromArmToEnd("Կարնո Քոչարի"));

        String armenianText = "Չոլախ Վաղո";
//        String armenianText = "Կարնո Քոչարի";
//        String armenianText = "Կարնո Քոչարի";
        String englishText = fromArmToEng(armenianText);
        System.out.println(armenianText + " - " + englishText);  // Output: "UYevYA
    ...
    public static String fromArmToEng(String armenianStr) {
